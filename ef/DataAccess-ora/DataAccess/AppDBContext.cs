...
namespace DataLayer
{
    public partial class AppDBContext : DbContext
    {
        ...
        public AppDBContext(string ConnectionString, string SchemaDefault)
        {
            _CS = ConnectionString;
            _DS = SchemaDefault; //"APPROVERDB"
        }
        ...
        {
            modelBuilder.HasDefaultSchema(_DS)
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "SYS_C008903")
                    .IsUnique();
